...
#define OHSystemTableViewBGColor ColorFromRGB16HEX(0xF5F5F5);   //UITableView 背景色
#define OHSystemGrayColor ColorFromRGB16HEX(0x666666)           //灰色
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([self.delegate respondsToSelector:@selector(pickerView:viewForRow:forComponent:reusingView:)]) {
        ...
        color = tableView.tag - TableTag == 0 ? [UIColor blackColor] : OHSystemGrayColor;
        isHiddenSplitLine = tableView.tag - TableTag == 0 ? YES : NO;
